    ...
    `}</style>
        <div className="flex sm:hidden">
            <button type="button" onClick={() => toggleNav()}>
                <svg className="fill-dsurface-200 mt-1 mr-1" width="36" height="36" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={"mobile_nav_menu fixed top-0 left-0 bg-black/90 w-screen h-screen z-1 p-6 flex-col justify-start items-end gap-8 hidden"}>
                <button type="button" onClick={() => toggleNav()}>
                    <svg className="fill-dsurface-200" width="36" height="36" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">

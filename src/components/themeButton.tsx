export default function ThemeButton() {
    return <>
            ...
            <button type="button" id="themeButtonDark" className="bg-transparent border-0 m-0 sm:ml-5 sm:mr-1">
                <svg id="themePicker" className="" width="32" height="32" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

...
<BlogImage
    src="/images/picoctf-noted/challenge-info-window.png"
...
var flag=fw.document.getElementsByTagName('p')[0].textContent;
var csrftoken;
...
<BlogImage
    src="/images/picoctf-noted/flag-posted-to-notes.png"

...
Thus concludes part 1 of this blog post. With the purpose of the project outlined and the design laid out, part 2 will dive into the actual Terraform and Ansible code that makes the magic happen!
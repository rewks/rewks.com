...
All of our Terraform code is now complete! Well, except for outputting some useful information. Make one final edit, this time to the top-level outputs.tf
...
Now go ahead and run the script! It takes about 80-90 seconds to complete, although about 70 seconds of that is just the EFS mount! It's like magic.
